...
def main_function():
    ...
    for i in range(10):
        ...
        for i in range(1, parts + 1):
            ...
            iter_data = _data.append(unlab_data) ## Edited Here

            [model, observs, seq_lengths, train_labs, observ_dict, uniq_observs] = hmm_setup(iter_data, "ShockFlag", "VisitIdentifier", "Multinomial")
            ...
            model.fit(observs, seq_lengths) ## Edited Here 
